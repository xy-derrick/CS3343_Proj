...
class batchTest {
	...
	private boolean testSystem(String resultPath)
	{
	 ...
	 void test03() throws IOException {
		 String savePath1=absolutePath+"\\testcase\\batchRes\\test_1.jpg";
		 String savePath2 = absolutePath+"\\testcase\\batchRes\\test_2.jpg";
		 ...
		 for(imgProcessor i: Software.getInstance().getImgProcessorList() ) 
		 { 
		 i.setName(test1Path); 
		 } 
