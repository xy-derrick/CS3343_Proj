...
public class JExpandablePanel extends JPanel {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<JComponent> JComList = new ArrayList<>();
        JLabel JL = new JLabel("hh");
        JL.setPreferredSize(new Dimension(100, 100));
        JComList.add(JL);
        JComList.add(new JLabel("hh"));
        JComList.add(new JButton("hh"));
        JExpandablePanel panels = new JExpandablePanel(Color.black, "title", 60, JComList);
        myPanel.add(panels);
