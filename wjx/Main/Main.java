...
import Code.Command.FilterDecorator.FlipHorizontal;
import Code.Command.FilterDecorator.FlipVertical;
import Code.Command.FilterDecorator.GrayFilter;
import Code.Command.FilterDecorator.HighContrastFilter;
import Code.Command.FilterDecorator.Rotate180Degrees;
import Code.Command.FilterDecorator.Rotate90DegreesClockwise;
import Code.Command.FilterDecorator.Rotate90DegreesCounterclockwise;
import Code.Command.FilterDecorator.VintageFilter;
import Code.Command.FilterDecorator.anticolor;
...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        String urlToReadImgFile = "design.png";
        main_software.setCommand(new readImgFromLocal(ip_01,urlToReadImgFile));
        main_software.execute();


        //main_software.setCommand(new Rotate90DegreesClockwise(new FilterCommand(ip_01)));
        //main_software.execute();
        //main_software.setCommand(new Rotate90DegreesCounterclockwise(new FilterCommand(ip_01)));
        //main_software.execute();
        //main_software.setCommand(new Rotate180Degrees(new FilterCommand(ip_01)));
        //main_software.execute();
        //main_software.setCommand(new FlipHorizontal(new FilterCommand(ip_01)));
        //main_software.execute();
        //main_software.setCommand(new FlipVertical(new FilterCommand(ip_01)));
        //main_software.execute();
        main_software.setCommand(new anticolor(new FilterCommand(ip_01)));
        main_software.execute();
